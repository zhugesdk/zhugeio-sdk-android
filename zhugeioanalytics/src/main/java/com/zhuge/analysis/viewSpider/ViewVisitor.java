...
/* package */ abstract class ViewVisitor implements Pathfinder.Accumulator {
    ...
    public static class AddAccessibilityEventVisitor extends EventTriggeringVisitor {
        ...
        public void accumulate(View found) {
            ...
            if (CodeLessConfig.viewTag.get(Integer.toString(found.hashCode())) ==null || !CodeLessConfig.viewTag.get(Integer.toString(found.hashCode())).contains(2))
            {
                found.setAccessibilityDelegate(newDelegate);
                mWatching.put(found, newDelegate);
                if (CodeLessConfig.viewTag.containsKey(Integer.toString(found.hashCode()))){
                    CodeLessConfig.viewTag.get(Integer.toString(found.hashCode())).add(new Integer(2));
                }else{
                    ArrayList<Integer> arrayList = new ArrayList<Integer>();
                    arrayList.add(2);
                    CodeLessConfig.viewTag.put(Integer.toString(found.hashCode()), arrayList);
                }
            }
        }
    ...
    private static final String LOGTAG = "Zhuge.ViewVisitor";
}
