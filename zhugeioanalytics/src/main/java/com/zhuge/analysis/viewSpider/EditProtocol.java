...
/* package */ class EditProtocol {
    ...
    public ViewVisitor readEventBinding(JSONObject source, ViewVisitor.OnEventListener listener) throws BadInstructionsException {
        try {
            ...
            if ("click".equals(eventType)) {
                ...
                throw new BadInstructionsException("Zhuge can't track event type \"" + eventType + "\"");
            }
        } catch (final JSONException e) {
            throw new BadInstructionsException("Can't interpret instructions due to JSONException. source :" + source.toString(), e);
        }
    }
    ...
    public Edit readEdit(JSONObject source) throws BadInstructionsException, CantGetEditAssetsException {
        ...
        try {
            ...
            if (source.getString("change_type").equals("property")) {
                ...
                visitor = new ViewVisitor.LayoutUpdateVisitor(path, newParams, source.getString("name"));
            } else {
    ...
    /**
     *
     * @param explicitId 明确的ID
     * @param idName     id名称
     * @param idNameToId 转换器
     * @return
     */
    ...
    private static final String LOGTAG = "Zhuge.EProtocol";
} // EditProtocol
