...
public abstract class WebSocketAdapter implements WebSocketListener {
     ...
     *
     * @see com.zhuge.analysis.java_websocket.WebSocketListener#onWebsocketHandshakeReceivedAsServer(WebSocket, Draft, ClientHandshake)
     */
    @Override
     ...
     *
     * @see com.zhuge.analysis.java_websocket.WebSocketListener#onWebsocketHandshakeSentAsClient(WebSocket, ClientHandshake)
     */
    @Override
     ...
     * This default implementation does not do anything. Go ahead and overwrite it
     *
     * @see com.zhuge.analysis.java_websocket.WebSocketListener#onWebsocketMessageFragment(WebSocket, Framedata)
     */
    @Override
     ...
     *
     * @see com.zhuge.analysis.java_websocket.WebSocketListener#onWebsocketPing(WebSocket, Framedata)
     */
    @Override
     ...
     * This default implementation does not do anything. Go ahead and overwrite it.
     *
     * @see com.zhuge.analysis.java_websocket.WebSocketListener#onWebsocketPong(WebSocket, Framedata)
     */
    @Override
