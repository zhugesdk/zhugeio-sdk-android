...
import com.zhuge.analysis.java_websocket.drafts.Draft.CloseHandshakeType;
import com.zhuge.analysis.java_websocket.drafts.Draft.HandshakeState;
import com.zhuge.analysis.java_websocket.drafts.Draft_10;
import com.zhuge.analysis.java_websocket.drafts.Draft_17;
import com.zhuge.analysis.java_websocket.drafts.Draft_75;
import com.zhuge.analysis.java_websocket.drafts.Draft_76;
import com.zhuge.analysis.java_websocket.exceptions.IncompleteHandshakeException;
...
import com.zhuge.analysis.java_websocket.framing.CloseFrameBuilder;
import com.zhuge.analysis.java_websocket.framing.Framedata;
import com.zhuge.analysis.java_websocket.framing.Framedata.Opcode;
...
import com.zhuge.analysis.java_websocket.handshake.Handshakedata;
...
import com.zhuge.analysis.java_websocket.server.WebSocketServer.WebSocketWorker;
import com.zhuge.analysis.java_websocket.util.Charsetfunctions;
...
public class WebSocketImpl implements WebSocket {
        ...
        try {
            ...
            for (Framedata f : frames) {
                ...
                if (curop == Opcode.CLOSING) {
                    ...
                    try {
                        String message = Charsetfunctions.stringUtf8(f.getPayloadData());
                        ...
                        wsl.onWebsocketMessage(this, message);
                    } catch (RuntimeException e) {
                        wsl.onWebsocketError(this, e);
                    }
    ...
    private void dealErrorMessage(String message) {
        try {
            JSONObject jsonObject = new JSONObject(message);
            String code = jsonObject.getString("code");
            String reason = jsonObject.getString("reason");
            Log.e("ZhugeSDK", "连接出错 code : " + code + " ; reason :" + reason);
        } catch (JSONException e) {
            Log.e("WebSocket", "Error :bad message" + message);
        }
    }
