...
public class Tweaks {
    /**
     * This method is used internally to expose tweaks to the Zhuge UI,
     * and will likely not be directly useful to code that imports the Zhuge library.
     ...
     * The Zhuge library uses this method internally to expose tweaks and their types to the UI. Most
...
//    })
     ...
     * tweaks to the Zhuge UI, and will likely not be directly useful to
     * code that imports the Zhuge library.
     */
    public static final
    @TweakType
    int BOOLEAN_TYPE = 1;
     ...
     * is used internally to expose tweaks to the Zhuge UI,
     * and will likely not be directly useful to code that imports the Zhuge library.
     */
    ...
    /**
     * This interface is used internally to expose tweaks to the Zhuge UI,
     * and will likely not be directly useful to code that imports the Zhuge library.
     */
    ...
    private static final String LOGTAG = "ZhugeSDK.Tweaks";
}
