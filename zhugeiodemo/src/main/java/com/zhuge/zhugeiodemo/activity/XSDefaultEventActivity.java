...
public class XSDefaultEventActivity extends AppCompatActivity implements OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        track = (Button) findViewById(R.id.track_event);
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.track_event:
                this.trackEvent(name, prop);
                break;
            default:
                break;
        }
    ...
    private void trackEvent(String eventName, JSONObject pro) {
...
//        }
        ...
        Tracker.track(this,eventName,pro);
