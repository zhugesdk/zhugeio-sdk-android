...
class ZhugeioAnalyticsDefaultMethodVisitor extends AdviceAdapter {

    String methodName

    ZhugeioAnalyticsDefaultMethodVisitor(MethodVisitor mv, int access, String name, String desc) {
